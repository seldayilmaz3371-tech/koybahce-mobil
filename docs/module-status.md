...
| 6 | AI Altyapısı (Provider/Tool/Context Engine/Sohbet) | 🟡 Kod kalitesi Sprint 10.6 ile Production seviyesine çıkarıldı (tool-calling kök neden düzeltmesi) — İmzalama ve Gerçek Cihaz TAM Doğrulaması bekleniyor, **Production Ready DEĞİL** |
