...
| 8 | Dashboard | 🟡 Sprint 8.4 (Hook+Screen) tamamlandı — Navigasyon bekliyor |
| 9+ | Hava Durumu/Harita/Fotoğraf Analizi/Sesli Asistan/RAG/Ayarlar/Raporlar | ⚪ Henüz başlamadı |
...
**Durum: 🟡 HOOK+SCREEN TAMAMLANDI, NAVİGASYON BEKLİYOR** (Sprint 8.4, 2026-07-18)

| Alan | Durum |
|---|---|
| Hook (`useDashboardSummary`) | ✅ Tamamlandı (6 test) |
| Screen | ✅ Tamamlandı (3 test) |
| Navigasyon Entegrasyonu | 🔴 Bekliyor — "Dashboard yeni ana ekran mı olacak?" kararı kullanıcı onayı gerektiriyor |
...
### Sonraki Adım
Dashboard'ın navigasyonu (yeni ana ekran mı, yoksa Parseller'e ek bir giriş mi) kullanıcı kararı gerektiriyor — bu, App.tsx'in varsayılan rotasını etkileyebilecek büyük bir değişiklik.
