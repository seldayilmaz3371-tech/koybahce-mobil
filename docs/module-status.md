...
| — | Bildirimler (Bakım Hatırlatmaları) | ✅ Tam işlevsel (Sprint 10.19) — Ayarlar hub'ı altında, `maintenance_plans.next_due_date` tabanlı, tamamen cihaz üzerinde yerel bildirimler, gerçek cihaz doğrulaması bekliyor |
| 11+ | Hava Durumu/Harita/Sesli Asistan/RAG/Ayarlar Hub Genişlemesi (Tema)/Raporlar/Finans+Hasat İşletme-Seviyesi Revizyonu | ⚪ Henüz başlamadı |
