...
describe("ParcelsScreen — Navigasyon", () => {
  it("'Reference Trees' butonu onViewReferenceTrees'i çağırır", () => {
    ...
    render(<ParcelsScreen onViewTrees={vi.fn()} onViewReferenceTrees={onViewReferenceTrees} onViewFinance={vi.fn()} onViewMaintenance={vi.fn()} onViewHarvest={vi.fn()} onViewAiChat={vi.fn()} onViewParcelAiChat={vi.fn()} onViewSettings={vi.fn()} onViewDashboard={vi.fn()} />);
  ...
  it("bir parseli düzenlerken 'View Trees' onViewTrees'i DOĞRU parselle çağırır", async () => {
    ...
    render(<ParcelsScreen onViewTrees={onViewTrees} onViewReferenceTrees={vi.fn()} onViewFinance={vi.fn()} onViewMaintenance={vi.fn()} onViewHarvest={vi.fn()} onViewAiChat={vi.fn()} onViewParcelAiChat={vi.fn()} onViewSettings={vi.fn()} onViewDashboard={vi.fn()} />);
  ...
  it("bir parseli düzenlerken 'View Finance' onViewFinance'i DOĞRU parselle çağırır (Sprint 4.3)", async () => {
    ...
    render(<ParcelsScreen onViewTrees={vi.fn()} onViewReferenceTrees={vi.fn()} onViewFinance={onViewFinance} onViewMaintenance={vi.fn()} onViewHarvest={vi.fn()} onViewAiChat={vi.fn()} onViewParcelAiChat={vi.fn()} onViewSettings={vi.fn()} onViewDashboard={vi.fn()} />);
  ...
  it("bir parseli düzenlerken 'View Maintenance' onViewMaintenance'i DOĞRU parselle çağırır (Sprint 5.3)", async () => {
    ...
    render(
      <ParcelsScreen onViewTrees={vi.fn()} onViewReferenceTrees={vi.fn()} onViewFinance={vi.fn()} onViewMaintenance={onViewMaintenance} onViewHarvest={vi.fn()} onViewAiChat={vi.fn()} onViewParcelAiChat={vi.fn()} onViewSettings={vi.fn()} onViewDashboard={vi.fn()} />
    );
