...
export const ROUTE_PATTERNS = {
  ...
  parcelBulkOperations: "/parcels/:parcelId/bulk-operations",
  ...
  photoAnalysis: "/photos/:photoId/analysis",
  aiChat: "/ai/chat",
  settings: "/settings",
...
export const buildPath = {
  ...
  parcelBulkOperations: (parcelId: string) => `/parcels/${parcelId}/bulk-operations`,
  referenceTrees: () => "/reference-trees",
  ...
  photoAnalysis: (photoId: string) => `/photos/${photoId}/analysis`,
  aiChat: () => "/ai/chat",
  settings: () => "/settings",
  aiSettings: () => "/settings/ai",
  dashboard: () => "/dashboard",
